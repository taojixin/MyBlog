<template>
  <div class="tag">
    ...
    <div class="cylinder">
      <div class="item" style="--i:1;--w:1.5"></div>
      <div class="item" style="--i:2;--w:1.6"></div>
      <div class="item" style="--i:3;--w:1.4"></div>
      <div class="item" style="--i:4;--w:1.7"></div>
      <div class="end" style="--i:1" ></div>
    </div>
    <div class="img"></div>
  </div>
</template>
...
.tag {
  ...
  .content {
    ...
    a {
      // text-decoration: none; 这里不用写，全局样式中写了
      color: #fff;
      font: 900 28px "";
    }
    h2 {
